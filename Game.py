...
def main():
    ...
    large_image = pygame.image.load(os.path.join(script_dir, "MainBG2.png"))
    large_image_width, large_image_height = large_image.get_size()

    # Load and resize the custom minimap image
    minimap_image = pygame.image.load(os.path.join(script_dir, "MiniMap.png"))
    ...
    rocket_images = [
        pygame.transform.scale(pygame.image.load(os.path.join(script_dir, "frame_0.png")), (96, 96)),  # First rocket image
        pygame.transform.scale(pygame.image.load(os.path.join(script_dir, "frame_1.png")), (96, 96)),  # Second rocket image
        pygame.transform.scale(pygame.image.load(os.path.join(script_dir, "frame_end.png")), (96, 96)),  # Third rocket image
    ]
    ...
    popup_image = pygame.image.load(os.path.join(script_dir, "RoverSelfie.png"))  # Replace with your image
